...
class ProductAdapter(val products: ArrayList<Data>, var clickListner: onProductsItemClickListener) : RecyclerView.Adapter<ProductAdapter.ViewHolder>() {
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView), View.OnClickListener {
        ...
        override fun onClick(view: View) {
            Toast.makeText(view.context, "${product.attributes.name} Diklik", Toast.LENGTH_SHORT).show()
        }
