...
//        rgSizeUpdate.check(rbSize.id)
        ...
        form {
            ...
            submitWith(btnSubmitUpdate) { result->
                ...
                apiInterface.updateProduct(product.attributes.id, productNameUpdate, productPriceUpdate, productStockUpdate, productDescriptionUpdate, productColorUpdate, productSizeUpdate)
